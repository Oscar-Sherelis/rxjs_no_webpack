...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"node_modules/tslib/tslib.es6.js":[function(require,module,exports) {
"use strict";
...
function sortData() {
  try {
    ...
    var propper = document.createElement('script');
    propper.type = 'text/javascript';
    propper.src = 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js';
    var jQuery = document.createElement('script');
    jQuery.src = 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js';
    var jQueryTable = document.createElement('script');
    jQueryTable.src = 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js';
...
function loadData(result) {
  return __awaiter(this, void 0, void 0, function () {
    var tbody, companyResponse, userResponse, companyStream$, userStream$;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          companyStream$ = rxjs_1.of(companyResponse);
          userStream$ = rxjs_1.of(userResponse);
          companyStream$.subscribe(function (companyRes) {
            return __awaiter(_this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    companyRes.forEach(function (company) {
                      result[parseInt(company.name)] = [];
                      var tr = document.createElement('tr');
                      var td3 = document.createElement('td'); // add first td = 'company_name'

                      addTd(tr, company.name); // remake userResponse

                      userStream$.subscribe(function (userResponse) {
                        return __awaiter(_this, void 0, void 0, function () {
                          return __generator(this, function (_a) {
                            userResponse.forEach(function (user) {
...
},{"DataTables.net":"node_modules/DataTables.net/js/jquery.dataTables.js","rxjs":"node_modules/rxjs/_esm5/index.js","../services/fetch":"services/fetch.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "17584" + '/');
